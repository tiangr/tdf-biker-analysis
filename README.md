...
- [x] Create a table of data, from which we can perform basic statistics to evaluate the best riders based on number of stage wins, overall wins, etc.
- [x] Perform network analysis 
    - [x] PageRank
    - [x] Combine Community detection with PageRank? We may require more analysis
    - [x] Visualize results
- [🛠️] Write a report
    - [x] Abstract
    - [x] Introduction
